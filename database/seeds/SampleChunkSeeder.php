...
class SampleChunkSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		for ($i=0; $i < 10000 ; $i++) { 
			DB::insert('insert into products (name, description, price, stock) value (:name, :description, :price, :stock)', [
		...
		$this->command->info('Berhasil menambah 10.000 data products mobil scr random !!!');
    }
}
